...
function dataToString(t)
    ...
    local s = "";
    -- Append prefix back (for compatibility)
    ...
    s = s .. "\29" .. f(t) .. "\29";
    -- Append suffix back (for compatibility)
...
---@param s string # The string that has the convention
...
function stringToData(s)
    ...
    -- Find the start and ending of the string we want to convert, it might have a prefix and / or suffix
